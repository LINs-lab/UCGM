...
from networks.swiglu_ffn import SwiGLUFFN
from networks.pos_embed import VisionRotaryEmbeddingFast
from networks.rmsnorm import RMSNorm
...
def LightningDiT_1p0B_1(**kwargs):
    return LightningDiT(
        depth=24, hidden_size=1536, patch_size=1, num_heads=24, **kwargs
    )


def LightningDiT_1p0B_2(**kwargs):
    return LightningDiT(
        depth=24, hidden_size=1536, patch_size=2, num_heads=24, **kwargs
    )


def LightningDiT_1p6B_1(**kwargs):
    return LightningDiT(
        depth=28, hidden_size=1792, patch_size=1, num_heads=28, **kwargs
    )


def LightningDiT_1p6B_2(**kwargs):
    return LightningDiT(
        depth=28, hidden_size=1792, patch_size=2, num_heads=28, **kwargs
    )


LightningDiT_models = {
    "LightningDiT-S/1": LightningDiT_S_1,
    "LightningDiT-S/2": LightningDiT_S_2,
